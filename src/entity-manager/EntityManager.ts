...
export class EntityManager {
   ...
   */
  createQueryBuilder<Entity extends object, Alias extends string>(
    entityClass: EntityTarget<Entity>,
    alias: Alias,
    queryRunner?: QueryRunner,
  ): SelectQueryBuilder<BaseTable<Entity, Alias>>;
   ...
   */
  createQueryBuilder<Entity extends object, Alias extends string>(
    entityClass?: Entity | QueryRunner,
    alias?: string,
    queryRunner?: QueryRunner,
  ): SelectQueryBuilder<BaseTable<Entity, Alias>> {
    if (alias) {
      return this.connection.createQueryBuilder(
        entityClass as Entity,
        alias,
